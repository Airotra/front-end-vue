...
computed: {
            ...
            districts: function () {
                if (this.form.city) {
                    return this.formatDistrictData(addressData[this.form.province][this.form.city])
                }
            }
        },
        methods: {
            ...
            save () {
                this.address.provice = this.form.province
                this.address.city = this.form.city
                this.address.district = this.form.district
            ...
            proChange: function (val, oldVal) {
                ...
                var data = this.formatData(addressData[this.form.province])
                for (var i = 0; i < data.length; i++) {
